...
#	error "GLM: GLM_GTX_extented_min_max is an experimental extension and may change in the future. Enable #define GLM_ENABLE_EXPERIMENTAL before including it, if you really want to use it."
#endif

...
glm::mat4 camera(float Translate, glm::vec2 const& Rotate)
{
	...
	glm::mat4 RawMesh = glm::scale(glm::mat4(1.0f), glm::vec3(0.5f));
	return Projection * View * RawMesh;
}
```
...
- Enable Cuda built-in function for abs function implementation with Cuda compiler
